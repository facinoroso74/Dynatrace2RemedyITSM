 ...
 */
public class MethodDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements noNamespace.MethodDocument
{
     ...
     */
    public noNamespace.MethodDocument.Method getMethod()
    {
        synchronized (monitor())
        {
            check_orphaned();
            noNamespace.MethodDocument.Method target = null;
            target = (noNamespace.MethodDocument.Method)get_store().find_element_user(METHOD$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setMethod(noNamespace.MethodDocument.Method method)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (noNamespace.MethodDocument.Method)get_store().add_element_user(METHOD$0);
            }
            target.set(method);
        }
    }
     ...
     * This is a complex type.
     */
    public static class MethodImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements noNamespace.MethodDocument.Method
    {
        private static final long serialVersionUID = 1L;
