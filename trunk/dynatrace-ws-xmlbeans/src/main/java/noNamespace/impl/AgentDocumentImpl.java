 ...
 */
public class AgentDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements noNamespace.AgentDocument
{
     ...
     */
    public noNamespace.AgentDocument.Agent getAgent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            noNamespace.AgentDocument.Agent target = null;
            target = (noNamespace.AgentDocument.Agent)get_store().find_element_user(AGENT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAgent(noNamespace.AgentDocument.Agent agent)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class AgentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements noNamespace.AgentDocument.Agent
    {
        private static final long serialVersionUID = 1L;
