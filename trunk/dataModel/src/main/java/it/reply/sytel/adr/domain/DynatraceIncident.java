...
//	remedyTicketIDStatus   TIMESTAMP,	
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2275420798639391590L;
	...
	public String toString() {
		return "DynatraceIncident [id=" + id + ", name=" + name + ", startEvent=" + startEvent + ", dashboarName="
				+ dashboarName + ", heatfield=" + heatfield + ", incidentType=" + incidentType + ", state=" + state
				+ ", duration=" + duration + ", endEvent=" + endEvent + ", source=" + source + ", session=" + session
				+ ", confimed_by=" + confimed_by + ", confirmation=" + confirmation + ", sensitivity=" + sensitivity
